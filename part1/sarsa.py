...
# Sarsa Algorithm agent
class SarsaAlgoAgent:
    # Init function
    ...
    def calculate_loss(self, batch_tuple):
        ...
        # We already know the future action index
        next_qvalue = self.model.forward(next_states)[actions]
        expected_qvalue = reward_vals + self.gamma * next_qvalue
        # Loss calculation
